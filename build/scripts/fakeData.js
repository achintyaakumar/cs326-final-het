...
var fakeData = /** @class */ (function () {
    ...
    fakeData.generateUser = function (data, response) {
    ...
    fakeData.generateMedia = function (data, response) {
        return __awaiter(this, void 0, void 0, function () {
            var mediaOne;
            return __generator(this, function (_a) {
                mediaOne = {
    ...
    fakeData.generateWatchlist = function (data, response) {
        return __awaiter(this, void 0, void 0, function () {
            var mediaOne, mediaTwo;
            return __generator(this, function (_a) {
                mediaOne = {
                    name: "Fox News",
                    biasR: "Partisan Right",
